...
public class App {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(sistema.obtenerCitas());
		
		IniciarSesion(sistema);
		
		System.out.println(sistema.obtenerClinicas());
		System.out.println(sistema.obtenerDentistas());
	}
	...
	private static void IniciarSesion(SistemaClinicas sistema) {
		...
		while(true) {
			...
			if(sistema.VerificadorC(rutIngresado, contraIngresada) == true) {
				...
				System.out.println("Inicio de sesion de ADMIN exitoso");
				MenuAdmin(sistema);
			}
			else {
	...
	private static void MenuCliente(SistemaClinicas sistema, String rut) {
		...
		if(entrada.equals("1")) {
			...
			System.out.println(sistema.agendarCita(rut));
			
		}
		else if(entrada.equals("3")) {
			System.out.println(sistema.completarCita(rut));
			System.out.println("Cita completada");
		}
		else if(entrada.equals("4")) {
			sistema.cancelarCitaCliente(rut);
			System.out.println("Cita cancelada");
		}
	...
	private static void MenuAdmin(SistemaClinicas sistema) {
		...
		if(entrada.equals("1")) {
			...
			sistema.obtenerSueldosDentistas();;
